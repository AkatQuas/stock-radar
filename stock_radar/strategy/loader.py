...
from stock_radar.core.paths import get_config_path
from stock_radar.core.registry import load_json_list, load_registry
...
def load_selectors() -> dict[str, Any]:
    ...
    return load_registry(
        ...
        list_key="selectors",
        module_path="stock_radar.strategy",
    )
...
def load_risk_selectors() -> dict[str, Any]:
    return load_registry(
        ...
        module_path="stock_radar.strategy.risk",
    )
...
def load_pool_selectors() -> dict[str, Any]:
    ...
    module = importlib.import_module("stock_radar.strategy.pool")
    result: dict[str, Any] = {}
